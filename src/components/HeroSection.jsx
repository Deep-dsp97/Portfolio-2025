    ...
    <section className="hero-section xl:container mx-auto bg-violet-50 shadow-inner flex flex-col justify-center items-center py-8 mt-5 rounded-3xl">
        <div>
            ...
            <div className="flex flex-row items-center">
              <Button customClass="inline-flex mt-4 text-white bg-indigo-600 border-transparent hover:bg-indigo-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-600">My Services</Button>
              <Button customClass="inline-flex mt-4 ml-3 border-indigo-500 bg-white text-indigo-500 hover:bg-indigo-500 hover:text-white">My Portfolio</Button>
            </div>
        </div>
    </section>
  )
